...
% $Id: setproperty.m 12979 2016-11-08 13:03:37Z santinel $
% $Date: 2016-11-08 05:03:37 -0800 (Tue, 08 Nov 2016) $
% $Author: santinel $
% $Revision: 12979 $
...
if any(fldsExtra)
    switch lower(onExtraField)
        ...
        case 'error'
            msg = [...
                sprintf('Unknown option names defined:\n'),...
                sprintf('   %s\n',flds2{fldsExtra}),...
                sprintf('Available options are:\n'),...
                sprintf('   %s\n',flds1{:})];
