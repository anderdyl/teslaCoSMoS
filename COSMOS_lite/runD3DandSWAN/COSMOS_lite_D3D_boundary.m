...
A0mag = inputs.wl; A0phase = 0;
A0 = sprintf('%0.7e\t',A0mag);
A0 = strrep(A0, 'e-0', 'e-0');
A0p = sprintf('%0.7e\t',A0phase);
A0p = strrep(A0p, 'e+0', 'e+0');
...
fprintf(fid,'%s\n',['A0         ' A0(1:13) '   ' A0p(1:13) '']);             % name of the boundary
